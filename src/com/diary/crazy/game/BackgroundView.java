...
public class BackgroundView extends View {
	...
	private final short[] mIndices = { 0, 1, 2, 0, 3, 4, 0, 1, 4 // Corner
																	// points
																	// for
																	// triangles
																	// (with
	...
	public BackgroundView(Context context, AttributeSet attrs) {
		...
		mColors[0] = typeArray.getColor(R.styleable.BackgroundView_colorSegmentOne, Color.RED);
		mColors[1] = typeArray.getColor(R.styleable.BackgroundView_colorSegmentTwo, Color.YELLOW);
		mColors[2] = typeArray.getColor(R.styleable.BackgroundView_colorSegmentThree, Color.BLUE);
		mColors[3] = typeArray.getColor(R.styleable.BackgroundView_colorSegmentFour, Color.GREEN);
